...
import (
	...
	"github.com/meeypioneer/etcd/pkg/netutil"
	"github.com/meeypioneer/etcd/pkg/srv"
...
type Config struct {
	...
	//
	// See https://github.com/meeypioneer/etcd/issues/9333 for more detail.
...
func (cfg *Config) SetupLogging() {
	...
	if cfg.LogPkgLevels != "" {
		repoLog := capnslog.MustRepoLogger("github.com/meeypioneer/etcd")
