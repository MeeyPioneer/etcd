...
var plog = capnslog.NewPackageLogger("github.com/meeypioneer/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/meeypioneer/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
